...
from regression2_abhisheks_e2etests_snowflake_automationjobs_project_duplicate_snowflake_sqlairflow_automation.tasks import (
    Branch_1,
    ForEachLoop_1_tg,
    Model_1,
    Python_0,
...
with DAG(
    dag_id = "regression2_abhisheks_e2etests_Snowflake_AutomationJobs_Project_Duplicate_Snowflake_SQLAirflow_Automation", 
