from regression1_abhisheks_e2etests_snowflake_automationjobs_project_snowflake_sqlairflow_automation.utils import *
...
"data" : join_2_strings(squared_numbers(5), "test value") != "hello"}],
    ...
    return PythonOperator(task_id = "Python_3", python_callable = return_method, show_return_value_in_logs = True)
